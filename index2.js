...
const userContainer = document.querySelector(".whethercontainer");
...
function renderWeatherInfo(weatherInfo) {
    ...
    const desc = document.querySelector("[datawhetherdescription]");
    const weatherIcon = document.querySelector("[data-whethreicon]");
